...
Another illustrative example (mortality data example) is in
the script `S-FPCA-mortality-example.R`, the data is in `FRA_Death_rates_1x2.txt`
...
approximation, using an S-estimator 
```{r mainblock, cache=TRUE}
